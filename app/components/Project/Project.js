					...
					<div className={'col-12'}>
						<div className={'left-padded'}>
							<div className={'cta-container'}>
								...
								<a href={`mailto:${projectData.email}`} onClick={()=>{ trackOutboundLink(`mailto:${projectData.email}`); return false; }} target={'_blank'} className={`contact-button ${mode}`}>Message {projectData.firstName}</a>
								...
								<ul className={'link-list'}>
									<a href={projectData.pitchVideoUrl} onClick={()=>{ trackOutboundLink(projectData.pitchVideoUrl); return false; }} target={'_blank'}><li>Pitch (3min video)</li></a>
									<a href={projectData.essayPDF} onClick={()=>{ trackOutboundLink(projectData.essayPDF); return false; }} target={'_blank'}><li>Essay (PDF)</li></a>
									<a href={projectData.linkedinUrl} onClick={()=>{ trackOutboundLink(projectData.linkedinUrl); return false; }} target={'_blank'}><li>LinkedIn Profile</li></a>
								</ul>
							</div>
